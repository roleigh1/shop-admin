...
export default function InsertData() {
    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
            ...
            <h4 style={{ marginTop: "2.5rem", marginBottom: "0.1rem" }}>Add a Product to the store</h4>

            <form method="POST" action={ "/profile-upload-single" } encType="multipart/form-data" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }} onSubmit={(e) => handleUpload(e, name, type, where, price, pictureInsert)} >
                <TextField id="outlined-basic" label="Name" value={name} onChange={(e) => setName(e.target.value)} variant="outlined" style={{}}required/>
                <FormControl>
                ...
                <TextField value={price} onChange={(e) => setPrice(e.target.value)} id="outlined-basic" label="Price" variant="outlined" style={{ width: "4rem" }} required />
                <Button component="label" variant="contained" startIcon={<CloudUploadIcon />}>
                    Upload file
                    <input type="file" style={{ display: "none" }} name="image" required onChange={handleFileChange} />
                </Button>
