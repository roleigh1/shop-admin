            ...
            <form onSubmit={handleSubmit} className="divider px-5 w-full">
                ...
                >
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-row gap-4 pt-3 w-full">
                            <FormControl>
                        ...
                        <div className="flex flex-col  gap-4 items-center w-full relative bottom-[1.4rem]">
                            <h2 className="text-sm font-medium relative bottom-[10px]">
                                Max redemptions
                            </h2>
                            <TextField
                                type="number"
                                variant="outlined"
                                size="small"
                                value={createVoucherFormData.maxredemptions ?? "0"}
                                name="maxredemptions"
                ...
                <div className="flex lg:flex-row flex-col gap-10 lg:gap-2 mt-3 lg:justify-center lg:items-start">
                    <div className="flex flex-col gap-4 justify-center items-center">
                        ...
                        />
                        <span className="opacity-40 text-xs  relative top-6 pb-3">Please enter the value without %</span>
                    </div>
                </div>
